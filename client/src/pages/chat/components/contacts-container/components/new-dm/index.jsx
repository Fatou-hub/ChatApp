...
const NewDM = () => {
    ...
    const selectNewContact = (contact) => {
        setOpenNewContactModal(false); // fermer la fenêtre modale une fois le contact séléctionné
        ...
        <>
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger>
                        <FaPlus
                            className="text-neutral-400 font-light text-opacity-90 text-small hover:text-neutral-100 
            ...
            <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
                ...
                flex flex-col gap-10">
                    ...
                    {searchedContacts.length <= 0 && (
                        <div className="flex-1 md:flex  mt-5
                         mf:mt-0 flex-col justify-center
                        ...
                        mt-5 lg:text-2xl text-xl transition-all duration-300 text-center ">
